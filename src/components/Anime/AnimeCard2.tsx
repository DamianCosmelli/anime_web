...
export function AnimeCard2({ title, episodie, imageUrl, youtubeVideoId }: CardProps) {
  return (
      ...
      {youtubeVideoId ? (
        ...
        >
         <AnimeTituloCard title={title} episodie={episodie} imageUrl={imageUrl} />
          ...
          {/* Botón "Ver Video" en el centro al hacer hover || TODO: SacarBoton y poner modal para ver info del anime y en la info el video (de estar) */}
